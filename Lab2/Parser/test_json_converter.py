...
def test_should_parse_simple_json77():
    simple_json = '{"key1" : 1.1 , "key2":[1,2,3], "key3"  :false, "key4": "i am string", "key5": 1 }'
    result = convert(simple_json)
    assert result != {"key1": 1.1, "key2": [1,2,3], "key3": False, "key4": "i am string", "key5": 1}
